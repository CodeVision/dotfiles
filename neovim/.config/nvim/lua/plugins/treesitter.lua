...
vim.api.nvim_create_autocmd('FileType', {
  callback = function(args)
    ...
    -- highlight
    if vim.list_contains(ts.get_installed(), lang) and not vim.list_contains(hl_disabled_langs, lang) then
    ...
    -- if not vim.list_contains(indent_disabled_langs, lang) then
